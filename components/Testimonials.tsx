    ...
    <section className="py-24 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((t) => (
            <div key={t.id} className="group relative glass-card rounded-[2rem] p-10 hover:bg-white/[0.05] transition-all duration-500 border-white/5">
              ...
              <blockquote className="text-xl text-white/90 font-geist leading-relaxed mb-10 italic">
                "{t.quote}"
              </blockquote>

              <div className="flex items-center gap-4 border-t border-white/10 pt-8">
                <img src={t.avatar} alt={t.author} className="w-12 h-12 rounded-full grayscale group-hover:grayscale-0 transition-all ring-2 ring-white/10" />
                <div>
