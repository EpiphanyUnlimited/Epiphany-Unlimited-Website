...
const services: ServiceGroup[] = [
  {
    ...
    // Image showing two people relaying information/collaborating
  ...
  },
  {
    ...
    // Image representing business architecture/systemic planning
            ...
            <article key={service.id} className="group relative glass-card rounded-[2.5rem] p-6 hover:bg-white/[0.05] transition-all duration-500 border-white/5 overflow-hidden flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-grow flex flex-col justify-between py-1">
                ...
                <div className="mt-4 pt-3 border-t border-white/5">
                  <button className="flex items-center gap-2 text-[10px] font-bold text-white group-hover:gap-3 transition-all uppercase tracking-widest">
                    Inquire Now
