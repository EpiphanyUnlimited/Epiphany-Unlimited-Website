          ...
          <div className="glass-card rounded-3xl p-8 flex flex-col transition-all">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/60 uppercase tracking-widest font-black">Diagnostic</p>
              </div>
            </div>
            
            <div className="mb-8">
              <span className="text-4xl font-geist font-black text-white">Custom</span>
              <span className="text-white/50 ml-2 font-medium">/ Assessment</span>
            </div>
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-white/60 uppercase tracking-widest font-black">Retainer</p>
                  </div>
                </div>
                <div className="px-3 py-1 bg-blue-500 rounded-full text-[10px] font-black text-white">POPULAR</div>
              </div>
              
              <div className="mb-8">
                <span className="text-4xl font-geist font-black text-white">$15k</span>
                <span className="text-white/50 ml-2 font-medium">/ Month</span>
              </div>
          ...
          <div className="glass-card rounded-3xl p-8 flex flex-col transition-all">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/60 uppercase tracking-widest font-black">Project-Based</p>
              </div>
            </div>
            
            <div className="mb-8">
              <span className="text-4xl font-geist font-black text-white">Custom</span>
              <span className="text-white/50 ml-2 font-medium">/ Project</span>
            </div>
