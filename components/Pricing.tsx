      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="glass-card rounded-3xl p-8 border-white/10 flex flex-col hover:bg-white/[0.04] transition-all">
            ...
            <button className="w-full h-12 rounded-2xl bg-white/5 border border-white/10 font-semibold hover:bg-white/10 transition-all">
              Book Assessment
            </button>
          </div>
          ...
          <div className="relative group rounded-3xl p-px overflow-hidden shadow-2xl">
            ...
            <div className="relative h-full glass-card rounded-3xl p-8 border-none bg-black flex flex-col z-10">
              ...
              <button className="w-full h-12 rounded-2xl bg-white text-black font-bold hover:bg-white/90 transition-all shadow-xl shadow-purple-500/20">
                Book Strategy Call
              </button>
            </div>
          </div>
