        ...
        <article className="glass-card rounded-[3rem] p-8 md:p-16 border-white/10 shadow-2xl relative overflow-hidden reveal">
          ...
          <div className="space-y-16 text-lg md:text-xl leading-relaxed text-white/80 font-geist font-light">
            ...
            <section className="space-y-8 reveal reveal-delay-2">
              ...
              {/* Cards with Significantly Increased Font Size */}
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="p-12 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/[0.08] transition-all hover:scale-[1.02] duration-300 shadow-xl group">
                  ...
                  <p className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight text-white/90">Everything is done <em className="text-blue-300 not-italic">empathetically</em>, to <em className="text-blue-300 not-italic">empower</em>, with <em className="text-blue-300 not-italic">enlightenment</em> and <em className="text-blue-300 not-italic">enlivenment</em>.</p>
                </div>
                <div className="p-12 bg-white/5 rounded-3xl border border-white/10 hover:bg-white/[0.08] transition-all hover:scale-[1.02] duration-300 shadow-xl group">
                  ...
                  <p className="text-2xl md:text-4xl lg:text-5xl font-bold leading-tight text-white/90">We move <em className="text-purple-300 not-italic">For Love Of Whatever</em> drives you: your goals, your people, your why.</p>
                </div>
              </div>
            ...
            <section className="py-12 reveal">
              <div className="relative p-12 md:p-20 bg-gradient-to-br from-blue-500/10 via-transparent to-purple-500/10 rounded-[4rem] border border-white/10 text-center shadow-inner shadow-white/5">
                ...
                <blockquote className="text-3xl md:text-5xl lg:text-6xl font-serif-brand italic text-white leading-[1.15] drop-shadow-md">
            ...
            {/* Experience - Updated Text and ENLARGED Premium Icons */}
            <section className="space-y-8 reveal">
              ...
              <div className="bg-white/5 rounded-[3rem] p-12 md:p-20 border border-white/10 space-y-16">
                <p className="font-semibold text-blue-400 uppercase tracking-widest text-lg md:text-2xl text-center md:text-left leading-relaxed">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-3 gap-16">
                  <li className="space-y-10 group text-center md:text-left">
                    <div className="w-32 h-32 rounded-[3rem] bg-blue-500/10 flex items-center justify-center text-blue-400 group-hover:bg-blue-500/20 group-hover:scale-110 transition-all duration-500 mx-auto md:mx-0 shadow-2xl shadow-blue-500/10 border border-white/5">
                      {/* Mapping Icon */}
                    ...
                    <p className="text-xl md:text-2xl text-white/70 leading-relaxed font-light">Mapping and improving processes, not just patching pain points.</p>
                  </li>
                  <li className="space-y-10 group text-center md:text-left">
                    <div className="w-32 h-32 rounded-[3rem] bg-blue-500/10 flex items-center justify-center text-blue-400 group-hover:bg-blue-500/20 group-hover:scale-110 transition-all duration-500 mx-auto md:mx-0 shadow-2xl shadow-blue-500/10 border border-white/5">
                      {/* Optimization Icon */}
                    ...
                    <p className="text-xl md:text-2xl text-white/70 leading-relaxed font-light">Reducing friction and waste so energy goes where it matters most.</p>
                  </li>
                  <li className="space-y-10 group text-center md:text-left">
                    <div className="w-32 h-32 rounded-[3rem] bg-blue-500/10 flex items-center justify-center text-blue-400 group-hover:bg-blue-500/20 group-hover:scale-110 transition-all duration-500 mx-auto md:mx-0 shadow-2xl shadow-blue-500/10 border border-white/5">
                      {/* Flow Icon */}
                    ...
                    <p className="text-xl md:text-2xl text-white/70 leading-relaxed font-light">Turning complex systems into clean, repeatable, natural flows.</p>
                  </li>
                </ul>
              </div>
            </section>
